...
/**
 * Manages "Authentication" to this app's backend service.  The SyncAdapter framework
 ...
 */
public class PosterAuthenticator extends AbstractAccountAuthenticator {

    public PosterAuthenticator(Context context) {
        super(context);
    }
