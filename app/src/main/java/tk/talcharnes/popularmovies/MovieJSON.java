...
//    String trailerList;
//    public void setTrailerListTextView(){
//        for (int i = 0; i< getMovieTrailerList().size(); i++){
//            Log.v("size", "" + getMovieTrailerList().size());
//            String trailerListItem = getMovieTrailerList().get(i).getMovieName().toString();
//            trailerList = trailerList + " " + trailerListItem;
//            Log.v("trailerlist = ", trailerList);
//        }
//        TextView trailerListTextView = (TextView) findViewById(R.id.trailer_list);
//        trailerListTextView.setText("" + trailerList.toString());
//    }
//    }
//
